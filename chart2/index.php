...
<html>
    <?php
        ...
        $result = mysqli_query($con, "SELECT sektor, perusahaan, tenagakerja 
        FROM kotabatu ORDER BY sektor"); // using mysqli_query instead

        $sektor = "";
        $perusahaan = "";
        $tenagakerja = "";
        while($res = mysqli_fetch_array($result)) {
            $sektor=$sektor."'".$res['sektor']."',"; 
            $perusahaan=$perusahaan."".$res['perusahaan'].","; 
            $tenagakerja=$tenagakerja."".$res['tenagakerja'].","; 
        }
...
<head lang="kr">
    ...
    <title>Graphic Pertama Saya</title>
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Banyaknya Perusahaan dan Tenaga Kerja WNI menurut Sektor di Kota Batu Tahun 2016'
    },
    yAxis: {
        title: 'Sektor'
    },
